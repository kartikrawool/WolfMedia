...
public class PaymentsController {
    ...
    @GetMapping("/undoMakeRoyaltyPayment")
    public String undoMakeRoyaltyPayment(@RequestParam Integer songId) throws Exception {
        return paymentsService.undoMakeRoyaltyPayment(songId);
    }
