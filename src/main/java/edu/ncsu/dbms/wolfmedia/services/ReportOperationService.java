...
public class ReportOperationService {
    ...
    public String updatePlayCount() {
        Connection connection = genericDAO.createConnection();
        try {

            Statement statement = connection.createStatement();
            statement.executeQuery("DELETE FROM songHistory WHERE month= 4 and year =2023");

            statement.executeQuery("INSERT INTO songHistory (songId, month, year, playCount) VALUES (1001, 4, 2023, 500)");
            statement.executeQuery("INSERT INTO songHistory (songId, month, year, playCount) VALUES (1002, 4, 2023, 1000)");
            statement.executeQuery("INSERT INTO songHistory (songId, month, year, playCount) VALUES (1003, 4, 2023, 100)");
            statement.executeQuery("INSERT INTO songHistory (songId, month, year, playCount) VALUES (1004, 4, 2023, 200)");

        } catch (SQLException e) {
            e.printStackTrace();
            return "Update Failed";
        }finally {
            genericDAO.closeConnection(connection);
        }
